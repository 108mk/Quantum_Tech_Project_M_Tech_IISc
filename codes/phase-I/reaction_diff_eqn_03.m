...
flag_source = 1; %source term indicator function
...
nu = 0.005; %U0*L0/Re0; % Viscosity/Diffusion cefficient

Tnl = L0/U0; % Nonlinear time
t_plot = Tnl*0.75; % Time to plot solution
...
burger_pde = @(x,t,u,dudx) deal(1, nu*dudx, -beta*u);    %%%%%%%%-----edited------main
burger_ic = u0;

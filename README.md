...
<!---
The core research theme that I aim to touch on is:

1. Quantum for Quantum: Simulating Quantum systems via quantum algorithms has been long considered since the 80s (due to Y. Manin and R. Feynman).
  
2. Quantum for Classical: "How efficient can it be to simulate classical systems via quantum algorithms?" There are numerous classical systems of academic and industrial importance. It remains to be seen how helpful quantum algorithmic paradigms could be.
